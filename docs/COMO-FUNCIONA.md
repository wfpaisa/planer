...
**Una orden directa manda sobre el criterio de la pasada.** Si quien construye pide expresamente que algo se recuerde —«recuerda que…», «agrégalo a las memorias»— se guarda, aunque la pasada no lo habría considerado una regla funcional: la lista de lo que la memoria no guarda existe para que el sistema no adivine solo, no para desautorizar al dueño de la app. La IA **reescribe en su respuesta aquello que hay que recordar**, sin darlo por guardado antes de que termine la pasada, porque la pasada solo ve el intercambio de ese turno y lo acordado en conversaciones anteriores no le llega de ninguna otra forma. Administrar la memoria —borrar una regla, reescribirla entera, leerla— sigue siendo de la caja de los ajustes. Por eso la sección viaja también con la memoria vacía: sin ella la palabra no está en el contexto, y a quien pide que se recuerde algo la IA le contestaba escribiendo la explicación dentro de la propia pantalla.
...
Una solicitud escrita mientras la IA trabaja espera en la cola y conserva el modo elegido al enviarla.
