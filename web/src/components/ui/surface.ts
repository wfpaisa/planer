 ...
 *
 * Un dialogo, un panel que se abre desde el encabezado o el cajon de una fila:
 * por dentro son cosas distintas, pero por fuera tienen que ser la misma
 * tarjeta. Antes cada uno traia su borde, su esquina y su linea --unos con
 ...
 * aqui solo estan sus nombres, para que todos se lo pongan igual.
 */
export const surface = {
  ...
  /** La fila de arriba, la del titulo. */
