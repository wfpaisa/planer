 ...
 *
 * El formato es el de cualquier hoja de calculo --tabulador entre columnas,
 * salto de linea entre filas, comillas alrededor de lo que lleve alguno de los
 * dos--, y por eso lo copiado aqui se pega en Excel y lo copiado en Excel se
 * pega aqui sin conversion de por medio.
 *
 * Lo que se copia es lo que se lee, no lo que hay guardado: una relacion sale
 * como su llave y no como el id, igual que se ve en la celda. Volver a pegarla
 * la resuelve contra la tabla destino, asi que la vuelta entera --copiar,
...
/** El rango elegido, como lo espera una hoja de calculo. */
 ...
 *
 * Siempre por tabulador: es lo que manda cualquier hoja de calculo. Adivinar el
 * separador aqui haria que pegar una sola celda con un punto y coma dentro
 * --una direccion, una lista-- se partiera en dos columnas.
 *
