 ...
 * el sistema. Lo único que lo mira es Monaco, que necesita un nombre de tema
 * suyo y no entiende de variables CSS.
 *
 * Vive en su propio modulo y no dentro de `planeDarkTheme.ts` porque ese es
 * un archivo de datos --colores y reglas-- que también lee el editor de solo
 * lectura; aquí esta lo único que hace falta vigilar.
 */
