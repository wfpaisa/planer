...
export interface BuilderValue {
  ...
  /**
   * Vuelve a leer los invitados a la aplicación.
   *
  ...
  /** Vuelve a leer la aplicación: nombre, icono, tema y colocacion del sidebar. */
   ...
   * el botón de importar de la lista de tablas lo elige del disco. El camino es
   ...
   * la búsqueda, el orden, la página-- así que no se entera de lo que pasa por
   ...
   *
   * Es distinta de `touched`, que cuenta cambios del diseño para el botón de
   * publicar: eso sube también al tocar una página o el tema, y releer todas
  ...
  touchData: () => void;
  /**
   * Sube uno cada vez que algo del diseño se guarda. Sirve para que el botón de
  ...
  /**
   * El dock de la IA. Vive aquí porque el botón que lo trae esta en el
   * encabezado y la columna se dibuja en la escena de la página.
   */
