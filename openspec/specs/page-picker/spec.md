# page-picker Specification

## Purpose
Permite señalar elementos del documento con un cursor de seleccion desde el dock, para que la IA reciba de contexto donde estan y que HTML tienen, sin que quien construye tenga que describirlos con palabras.
