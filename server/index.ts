...
const ROUTES: [RegExp, string, Handler][] = [
  ...
  [/^\/api\/constructores$/, "GET", api.listBuilders],
  [/^\/api\/constructores$/, "POST", api.createBuilder],
  [/^\/api\/constructores\/([^/]+)$/, "PATCH", api.updateBuilder],
  [/^\/api\/constructores\/([^/]+)$/, "DELETE", api.deleteBuilder],
