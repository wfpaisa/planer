 ...
 *
 * Un filtro se escribe como texto (`app = "abc123"`), así que todo valor que
 * venga de fuera --un id que manda una página, un correo que se escribe en el
 ...
 * cierra donde el valor todavía seguia. A partir de ahi lo que quedaba del
 * valor se lee como filtro: en el mejor caso la consulta no compila, y en el
 * peor dice algo que nadie escribio.
 *
 * Vive aquí y no copiado en cada archivo porque antes había nueve copias de
 * media línea, y las nueve escapaban de menos.
 */
